...
repositoryAutreEquipement.save(new AutreEquipement("Avertissement de distance", "Abstandswarnung", "Distance warning"));
repositoryAutreEquipement.save(new AutreEquipement("Phares adaptatifs", "Adaptives Kurvenlicht", "Adaptive headlights"));
repositoryAutreEquipement.save(new AutreEquipement("toutes roues motrices", "Allradantrieb", "all-wheel drive"));
